...
<head>
  ...
  <title>Admin Naraclothes | Dashboard</title>
  <!--====== Favicon Icon ======-->
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light border-bottom">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('landing') }}" class="nav-link" target="_blank">Landing Page</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('dashboard') }}" class="brand-link">
      <img src="{{ asset('dist/img/irit.io-logo.jpg') }}" alt="Irit.IO Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          {{-- Size --}}
          <li class="nav-item">
            <a href="{{ route('size.index') }}" class="nav-link {{ request()->routeIs('size*')?'active':'' }}">
              {{-- <i class=" far fa-newspaper"></i> --}}
          ...
          {{-- Varsize --}}
          <li class="nav-item">
            <a href="{{ route('var-size.index') }}" class="nav-link {{ request()->routeIs('var-size*')?'active':'' }}">
              {{-- <i class=" far fa-newspaper"></i> --}}
          ...
          {{-- Button --}}
          <li class="nav-item">
            <a href="{{ route('button.index') }}" class="nav-link {{ request()->routeIs('button*')?'active':'' }}">
              {{-- <i class=" far fa-newspaper"></i> --}}
          ...
          {{-- Setting --}}
          <li class="nav-item">
            <a href="{{ route('setting.show') }}" class="nav-link {{ request()->routeIs('setting*')?'active':'' }}">
              {{-- <i class=" far fa-newspaper"></i> --}}
