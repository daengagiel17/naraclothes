        ...
        <div class="row">
          <div class="col-md-6 offset-md-3">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{ route('gambar.store', ['post_id' => $post_id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                ...
                <div class="card-footer">
                  ...
                  <a  href="{{ route('gambar.index', ['post_id' => $post_id]) }}" class="btn btn-danger">Back</a>
                </div>
              </form>
            </div>
            <!-- /.card -->
