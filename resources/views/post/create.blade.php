              ...
              <form role="form" action="{{ route('post.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="excellence" name="excellence" rows="3" placeholder="Enter Excellence"></textarea>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="price_old" name="price_old" placeholder="Enter Price Old">
                  </div>
                  <div class="form-group">
